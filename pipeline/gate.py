...
# 問いの文言は、本人が96件にラベルを付けた結果（2026-09-21）に合わせて書き直した。
# 書き直す前は、秘密情報を25%、場所を0%しか拾えていなかった。
SEMANTIC_QUESTIONS = {
    "他人の私的情報": "この文章に、本人以外の人（相手・同僚・利用者・家族など）について分かる記述がありますか？様子、発言、予定、事情のいずれかが書かれていれば「はい」。",
    "秘密情報": "この文章に、外部に出したくない業務上・安全上の情報が含まれますか？鍵・パスワード・ID・機器やネットワークの設定・設備の不備や弱点・社内の予定や事情のいずれかが書かれていれば「はい」。",
    "場所が分かる": "この文章から、特定の場所が分かりますか？地名・駅名・施設名・建物名・棟や部屋の名称のいずれかが書かれていれば「はい」。",
}
